...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        Widget.resize(543, 408)
        self.savebox = QtWidgets.QGroupBox(Widget)
        self.savebox.setGeometry(QtCore.QRect(380, 10, 151, 131))
        ...
        self.inputbox.setGeometry(QtCore.QRect(10, 10, 361, 131))
        self.inputbox.setObjectName("inputbox")
        self.drop_area = QtWidgets.QLabel(self.inputbox)
        self.drop_area.setGeometry(QtCore.QRect(40, 20, 281, 71))
        ...
        self.pushButton.setGeometry(QtCore.QRect(140, 100, 75, 24))
        self.pushButton.setObjectName("pushButton")
        self.output_area = QtWidgets.QListWidget(Widget)
        self.output_area.setGeometry(QtCore.QRect(10, 150, 521, 241))
